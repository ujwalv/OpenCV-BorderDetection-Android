                ...
                new AsyncTask<Void,Void,Uri>(){
                    ...
                    protected Uri doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            tempMat = getMatFromBitmap(tempBitmap);
                            Imgproc.cvtColor(tempMat, tempMat, Imgproc.COLOR_BGR2GRAY, 4);
                            Imgproc.GaussianBlur(tempMat, tempMat, new org.opencv.core.Size(11, 11), 20);
                            Imgproc.adaptiveThreshold(tempMat, tempMat, 255, Imgproc.ADAPTIVE_THRESH_MEAN_C, Imgproc.THRESH_BINARY, 71, 7);
                            //Imgproc.adaptiveThreshold(tempMat, tempMat, 255, Imgproc.ADAPTIVE_THRESH_GAUSSIAN_C, Imgproc.THRESH_BINARY, 11, 11);
...
*/
    ...
    public Mat getMatFromBitmap(Bitmap bitM) throws Exception{
        if(bitM==null){
            Log.e(TAG,"Sleeping");
            Thread.sleep(3000);
        }
